    ...
    <div class="video__partner">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <button id="recordPlay" :disabled="recordPlayFlag" @click="recordPlay">播放录屏</button>
          </td>
          <td>
            <button id="download" :disabled="downloadRecordFlag" @click="downloadRecord">下载录屏</button>
          </td>
        </tr>
        <tr>
          <td>
            <button id="snapshot" @click="snapshot">截图</button>
            <canvas id="picture" ref="picture"></canvas>
          </td>
          <td>
            <button id="startLocalMedia" @click="startLocalMedia">摄像头直播</button>
          </td>
          <td>
            <button id="startCapture" @click="startCapture">屏幕共享直播</button>
          </td>
        </tr>
      </table>
    </div>
